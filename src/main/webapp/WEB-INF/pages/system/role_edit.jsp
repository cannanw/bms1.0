...
<section class="wrapper">
	<h3 id="titleId"><i class="fa fa-angle-right"></i> 添加角色</h3>
		...
		<div class="col-lg-12">
			...
			<form class="form-horizontal" id="editRoleForm">
				...
				<div class="form-group">
					...
					<input type="button" value="确定" class="btn btn-primary btn_save">
					&nbsp;&nbsp;
...
<script type="text/javascript" src="${basePath}/bms/system/role_edit.js"></script>